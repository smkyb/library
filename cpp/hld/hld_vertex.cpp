...
template<template<typename S, auto op, auto e, typename F, auto mapping, auto composition, auto id> typename node_type, typename S, auto op, auto e, typename F, auto mapping, auto composition, auto id>
struct _hld_7{
    int *dum0, *dum1;
    int n, r, edge_idx;
    ...
    node_type<S, op, e, F, mapping, composition, id> node[2];
...
template<template<typename S, auto op, auto e> typename node_type, typename S, auto op, auto e>
struct _hld_3{
    int *dum0, *dum1;
    int n, r, edge_idx;
    int *dep, *in, *out, *head, *par;
